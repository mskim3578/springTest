...
<div class="w3-bar w3-light-grey">
    ...
    <a href="<%=request.getContextPath() %>/member/joinForm" class="w3-bar-item w3-button w3-hide-small">회원가입</a>
      <a href="<%=request.getContextPath() %>/member/loginForm" class="w3-bar-item w3-button w3-hide-small">로그인</a>
    ...
    회원정보확인(<%=session.getAttribute("id") %>)</a> 
  	<a href="<%=request.getContextPath() %>/member/logout" class="w3-bar-item w3-button w3-hide-small">로그아웃</a>
